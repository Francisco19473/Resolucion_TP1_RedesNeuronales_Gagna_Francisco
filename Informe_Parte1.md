...
Para aislar las variables detrás de las configuraciones óptimas, se aplicó un filtro por embudo restringiendo el estudio a modelos con un val_accuracy≥55.5% y un sobreajuste entre el 0% y el 5%. El análisis de coordenadas paralelas confirmó la coexistencia de un modelo líder singular que alcanza el rendimiento absoluto del experimento (65.85%) con una brecha cercana al 5%, y un conjunto denso de modelos situados entre el 58% y el 63.5% de exactitud, caracterizado por brechas compactas entre 0.0 y 3.0, representando la región de diseño más robusta del espacio de búsqueda.
